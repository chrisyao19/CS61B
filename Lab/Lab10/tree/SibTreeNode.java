...
class SibTreeNode extends TreeNode {
  ...
  public TreeNode parent() throws InvalidNodeException {
    ...
    if(!this.isValidNode()) throw new InvalidNodeException("Invalid Node");
    if(this.parent==null){
      SibTreeNode x = new SibTreeNode();
      return x;
    }else{
      return this.parent;
    }
  ...
  public void insertChild(Object item, int c) throws InvalidNodeException {
    if(isValidNode()){
      SibTreeNode tmp = new SibTreeNode(this.myTree, item);
      if(c<1) c=1;
      if(this.children()==0){
        tmp.parent = this;
        this.firstChild = tmp;
        ...
        tmp.parent = this;
        SibTreeNode x = (SibTreeNode)this.firstChild;
        this.firstChild = tmp;
        tmp.nextSibling = x;
      }
      else if(c>this.children()){
        tmp.parent = this;
        SibTreeNode last = (SibTreeNode)this.child(children());
        last.nextSibling = tmp;
      }
      else if(c<=this.children() && c!=1){
        tmp.parent = this;
        SibTreeNode c_1 = (SibTreeNode)this.child(c-1);
        SibTreeNode c_2 = (SibTreeNode)this.child(c);
        c_1.nextSibling = tmp;
        tmp.nextSibling = c_2;
      }
      this.myTree.size++;
      ...
      if(this.firstChild==null){
        ...
        if(this.parent != null){
          if(this.parent.firstChild == this){
            ...
            SibTreeNode x = this.parent.firstChild;
            while(x.nextSibling!=this) x = x.nextSibling;
            x.nextSibling = this.nextSibling;
          }
          this.parent = null;
