...
public class SList {
  ...
  public void insertEnd(Object obj) {
    if (head == null) {
      ...
      SListNode node = tail;
      SListNode last = new SListNode(obj);
      node.next = last;
      tail = last;
      size++;
    }
  ...
  public static void main (String[] args) {
    ...
    SList s = new SList();
    s.insertFront(6);
    s.insertEnd(new Integer(9));
    s.insertEnd(new Integer(12));
    System.out.println("Here is a list of[ 6 9 12 ]:"+s);
    s.insertFront(new Integer(3));
    s.insertEnd(new Integer(15));
    System.out.println("Change it to [ 3 6 9 12 15]:"+s);
    testEmpty();
