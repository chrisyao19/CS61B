...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    int length = table.bucket();
    double collisions = numBoards - length + length*(Math.pow(1-(double)(1.0/length),length));
    System.out.println("The number of input is:" + numBoards);
    System.out.println("The number of bucket is:" + length);
    System.out.println("The load factor is:" + (Double)(table.size()/(double)length));
    System.out.println("The expected number of collision is:" +collisions);
    System.out.println("The real collisions are:" + table.collision_num);
    System.out.println("" + table);
    System.out.println("the collision number:" + table.number_of_collision());
